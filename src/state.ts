...
export interface LastReadState {
  // knowledge of data structure for last read state, constains USFM and Chapter.
  usfm: string;
  chapter: number;
}
